export const experiences = [
  ...
  // {
  //   _id: 'vagabond-nomad',
  //   title: 'Spiritual journey as wonderer',
  //   date: 'Sept 2021 - Jan 2022',
  //   position: 'Vagabond - Nomad',
  //   coverPath: '/static/companies/vagabond.jpg',
  //   work: [
  //     'A wanderer free from the known, free from concepts and words',
  //     'Backpacking with camping tools and guitar. Travel alone and connecting to nature and mother earth',
  //     'Work in exchange for food: construction, cleaning/feeding/riding horses',
  //     'Develop compassion and understanding that love is so powerful: to love and accept everything as it is with no judgement',
  //     'Values I ve learned through this wonderful journey: Being present here and now, the world is a mirror of you, fear is what holds you down, we are living in heaven, evil comes from inside not outside',
  //     'Skills I ve learned through amazing experience: horse riding, communication and highly extrovert personality, herbs and plants'
  //   ]
  // },
  {
  ...
  // {
  //   _id: 'frontend-engineer-mobile-developer',
  //   title: 'Full-time job',
  //   company: 'CleverTech France',
  //   date: 'Dec 2020 - Mars 2021',
  //   position: 'Frontend Engineer, Mobile Developer',
  //   coverPath: '/static/companies/clevertech.png',
  //   work: [
  //     'As a part of my daily activities, I share with the team progress, as well as helping them reach their goals especially when it comes to advanced concepts and best practices. Which allows me to build the go-to person reputation',
  //     'Architect and develop mobile application using React Native CLI which includes REST API, JWT authentication and authorization, Async storage persistence, Redux Toolkit for state management, document upload, nested routing, and navigation',
  //     'Create reusable components and share it with the team to enhance productivity and reduce code duplication',
  //     'Reading and making daily research on technology and learning advanced concepts in React.js and development in general'
  //   ]
  // },
  {
  ...
  },
  {
    ...
    work: ['Implement new feature in company platform to enhance user experience']
  },
  {
  ...
  },
  {
    ...
    work: ['Develop a web application that solve long waiting time in hospital emergency rooms']
  }
];
